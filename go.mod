...
replace github.com/zclconf/go-cty => github.com/nywilken/go-cty v1.13.3 // required for packer-plugin-sdk RPC gob encoding; see hashicorp/packer-plugin-sdk#187
